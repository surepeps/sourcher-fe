...
function HomeBanner({config, countries, industries}) {
  ...
  return (
    <div className='bg-no-repeat bg-center bg-cover flex flex-col gap-6 lg:gap-8 justify-center items-center pt-36 lg:pb-36 pb-14 font-semibold font-notoSans' style={{ backgroundImage: `url(${config.homeBanner})`}}>
      <h1 className="lg:text-6xl text-4xl text-textWhite w-full md:w-10/12 lg:w-8/12 xl:w-6/12 2xl:w-4/12 text-center !leading-snug"> Find & Connect with Experts </h1>
      ...
      <div className="lg:w-auto w-[92%] px-2  mx-auto bg-bgColor rounded-xl py-2 mt-5 lg:mt-8 lg:mb-10 flex lg:flex-row flex-col gap-3">
        ...
        <div className="lg:h-full lg:w-0.5 bg-[#0F172A13] w-full h-0.5 rounded-xl"></div>
          ...
          <select className='focus:outline-none border-none text-sm lg:text-md forceOutlineNone py-0 w-full lg:w-[130px]' name="country" id="country">
          ...
          <select className='border-none py-0 text-sm lg:text-md' name="expertise" id="expertise">
