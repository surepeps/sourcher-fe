...
function Step3({userData, moveToNext}) {
  ...
  return (
    <div className="px-2">
      ...
      <div className="mt-10 flex flex-col gap-5">
        <button disabled={activateNextButton} onClick={() => moveToNext(4, 3)} type="button" className="w-full py-5 rounded-lg px-4 text-sm text-white bg-awimGreen hover:bg-awimFadeGreen focus:outline-none focus:shadow-outline transition duration-300 ease-in-out">
          Next
        </button>

        <button onClick={() => moveToNext(4, 3)} type="button" className="w-full py-5 rounded-lg px-4 text-sm border border-awimGreen text-awimGreen hover:bg-awimGreen hover:text-textWhite focus:outline-none focus:shadow-outline transition duration-300 ease-in-out">
          Skip for Later
        </button>
      </div>
