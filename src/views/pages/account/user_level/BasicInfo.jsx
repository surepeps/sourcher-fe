...
function BasicInfo({allData}) {
  const {ProfileData, myData, config, isProfileLevel1, isMyAccount} = allData;
    ...
    <div>
      ...
      {/* Upgrade to level Two */}
      {
        isMyAccount && isProfileLevel1 ? (
          <div className="border-2 cursor-pointer flex flex-col gap-10 w-full lg:w-3/5 border-dashed border-awimYellow rounded-lg bg-awimLightYellow p-8 ">
            <div className="flex justify-between items-end gap-2">
              <div className="flex flex-col gap-3">
                <h2 className="text-awimYellow text-2xl font-semibold">Upgrade to Level 2</h2>
                <p>Upgrade your account to get full excess to experts</p>
              </div>
              <div className="lll">
