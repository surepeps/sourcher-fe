...
function ProfileBanner({allData}) {
    ...
    const socialStatus = twitter || instagram || linkedin || youtube;
...

                    {
                        ...
                        (
                            <div className='w-[55%] flex flex-col gap-1'>
                                ...
                                {
                                    !isMyAccountLevel1 && (socialStatus) ? 
                                        <div className={`social px-5 py-3 rounded-lg flex w-[80%] ${iamLoggedIn && isMyAccount ? 'lg:w-[45%]' : iamLoggedIn && !isMyAccount ? 'lg:w-auto' : socialStatus ? 'lg:w-auto' : ''} gap-6 justify-between bg-[#ffffff16]`}>
                                            {
                                                twitter ? 
                                                <span>
                                                    <NavLink to={`https://${twitter}`}>
