...
import AddPublication from '../../../modals/account/AddPublication';
...
function Publications() {
  ...
  return (
    <div>
        ...
        <div className="allPublications w-full">
            <div className="singlePub gap-4 flex w-full justify-between flex-col lg:flex-row ">
                <div className="ll bg-[#FEF8F1] w-auto flex flex-col lg:flex-row gap-8 px-8 py-5 rounded-lg">
                    ...
                    <NavLink to="" className="flex gap-2 items-center">
                        ...
                        http://nobleawards.com
                    </NavLink>  
                </div> 
                <div className="flex gap-4 items-center">
                    <button className='border border-red-600 bg-transparent text-red-600 hover:bg-red-600 hover:text-white px-3 py-2 rounded-md transition duration-300 ease-in-out'>
                    ...
                    <button className='border border-awimGreen bg-transparent text-awimGreen hover:bg-awimGreen hover:text-white px-3 py-2 rounded-md transition duration-300 ease-in-out'>
                        <svg className='fill-current' width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
