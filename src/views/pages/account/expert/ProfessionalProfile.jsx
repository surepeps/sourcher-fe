...
import EditProfessional from '../../components/expert_reg/professions/EditProfession';
import SingleProfessional from '../../components/expert_reg/professions/SingleProfessional';
import SingleWorkExperience from '../../components/expert_reg/work_experience/SingleWorkExperience';
import EditWorkExperience from '../../components/expert_reg/work_experience/EditWorkExperience';




function ProfessionalProfile({ProfileData, userData,config}) {
  ...
  return (
    <div className="px-2 w-full lg:w-[60%]">
