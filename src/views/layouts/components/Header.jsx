...
function Header({config}) {
  ...
  return (
    <div className=''>
      <nav className="bg-white py-2 border-gray-200 dark:bg-gray-900 ">
        ...
        <div className="flex items-center md:order-2 gap-3 px-4">
            ...
            <div className={`z-50 ${isLanguageMenuOpen ? 'block' : 'hidden'} my-4 absolute top-14 right-8 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700`} id="language-dropdown-menu">
            ...
            <button onClick={toggleMobileMenu} aria-expanded={isMobileMenuOpen ? 'true' : 'false'}  type="button" className={`inline-flex items-center p-2 w-9 h-9 justify-center text-sm text-gray-500 rounded-lg md:hidden bg-awimGreen focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="navbar-language transition-transform duration-300 ${isMobileMenuOpen ? 'transform rotate-180' : ''} `}>
              {
                !isMobileMenuOpen ? (
        ...
        <div className={`items-center justify-between ${isMobileMenuOpen ? 'block' : 'hidden'} w-full bg-white rounded-b-2xl md:flex md:w-auto md:order-1 transition-transform ease-in-out duration-300`} id="navbar-language">
          <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg  md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white transition-max-height duration-300 ease-in-out">
            <li>
